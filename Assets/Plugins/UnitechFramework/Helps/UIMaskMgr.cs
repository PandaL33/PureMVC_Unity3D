...
namespace Unitech.Net.UnityFramework
{
    public class UIMaskMgr : MonoBehaviour
    {
        ...
        {
            //得到UI根节点对象、脚本节点对象
            _GoCanvasRoot = GameObject.FindGameObjectWithTag(SysDefine.SYS_TAG_UIROOT);
            ...
            _GoMaskPanel = UnityHelper.FindTheChildNode(_GoCanvasRoot, SysDefine.SYS_UIMASKPANEL_NODE).gameObject;
            //得到UI摄像机原始的“层深”
        ...
        public void SetMaskWindow(GameObject goDisplayUIForms, UIFormLucencyType lucencyType = UIFormLucencyType.Lucency)
        {
            ...
            if (_UICamera != null)
            {
                _UICamera.depth = _UICamera.depth + SysDefine.SYS_UICAMERA_DEPTH_INCREMENT;    //增加层深
            }
        }
